...
<section class="animate">
	<div class="py-8 lg:py-16 text-column mx-auto max-w-screen-md">
		...
		<div id="dataProtection" class="category text-sm xl:text-base { colorText }" style="display: block;">
			...
			55116 Mainz<br>
			<br>
			Dieser ist Empfänger Ihrer personenbezogenen Daten. Dies entspricht unserem berechtigten Interesse im Sinne des Art. 6 Abs. 1 S. 1 lit. f DSGVO, selbst keinen Server in unseren Räumlichkeiten vorhalten zu müssen. Serverstandort ist Deutschland.
			<br><br>
			Sie haben das Recht der Verarbeitung zu widersprechen. Ob der Widerspruch erfolgreich ist, ist im Rahmen einer Interessenabwägung zu ermitteln.
			<br><br>
			Die Daten werden gelöscht, sobald der Zweck der Verarbeitung entfällt, spätestens nach 14 Tagen.
			<br><br>
